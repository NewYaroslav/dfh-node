 ...
 * \details Хранит счётчики активных соединений и ограничивает их по заданному лимиту.
 */
#pragma once
...
public:
    ...
    /// \param max_connections Максимально допустимое число соединений для fingerprint.
