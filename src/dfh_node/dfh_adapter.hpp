...
public:
    ...
    virtual std::unique_ptr<QueryHistoryResponse> query_history(std::unique_ptr<QueryHistoryRequest> req) = 0;
    ...
    virtual std::unique_ptr<GetBlockDfhbinResponse> get_block_dfhbin(std::unique_ptr<GetBlockDfhbinRequest> req) = 0;
    ...
    virtual std::unique_ptr<ListBlockMetaResponse> list_block_meta(std::unique_ptr<ListBlockMetaRequest> req) = 0;
    ...
    virtual std::unique_ptr<GetBlockHashResponse> get_block_hash(std::unique_ptr<GetBlockHashRequest> req) = 0;
};
