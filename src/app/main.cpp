...
void print_usage() {
  std::cerr << "Usage: dfh_node_app --config <path>\n";
}
...
int main(int argc, char** argv) {
  ...
  LOG_INFO("dfh-node v%s starting...", std::string(dfh_node::version()).c_str());
  ...
  LOG_INFO(
      "Status: node_id=%s, version=%s, build=%s, uptime_ms=%llu, peers_count=%llu, env=%s",
