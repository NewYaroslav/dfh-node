...
#define LOG_TRACE(...)                                                         \
    ::dfh_node::logging::log_trace(__FILE__, __LINE__, DFH_LOG_FUNCTION,       \
                                   __VA_ARGS__)
#define LOG_DEBUG(...)                                                         \
    ::dfh_node::logging::log_debug(__FILE__, __LINE__, DFH_LOG_FUNCTION,       \
                                   __VA_ARGS__)
#define LOG_INFO(...)                                                          \
    ::dfh_node::logging::log_info(__FILE__, __LINE__, DFH_LOG_FUNCTION,        \
                                  __VA_ARGS__)
#define LOG_WARN(...)                                                          \
    ::dfh_node::logging::log_warn(__FILE__, __LINE__, DFH_LOG_FUNCTION,        \
                                  __VA_ARGS__)
#define LOG_ERROR(...)                                                         \
    ::dfh_node::logging::log_error(__FILE__, __LINE__, DFH_LOG_FUNCTION,       \
                                   __VA_ARGS__)
